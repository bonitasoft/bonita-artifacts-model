...
class OrganizationParserTest {
    ...
    @Test
    void should_parse_organization_work() throws Exception {
        //given
    ...
    @Test
    void should_replace_old_namespace() throws Exception {
        //given
    ...
    @Test
    void should_parse_simpleOrganization_work() throws Exception {
        //given
    ...
    @Test
    void should_parse_organization_with_both_user_having_mix_encryption_passw_work() throws Exception {
        //given
    ...
    @Test
    void should_parse_organizationWithCycle_work() throws Exception {
        //given
    ...
    @Test
    void should_parse_OrganizationWithSpecialCharacters_work() throws Exception {
        //given
    ...
    @Test
    void should_parse_ACME_work() throws Exception {
        //given
