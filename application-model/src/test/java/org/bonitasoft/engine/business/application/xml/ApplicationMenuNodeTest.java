...
class ApplicationMenuNodeTest {

    @Test
    void setter_and_getter_are_working() {
        //given
        ...
        //then
        assertThat(menuNode).hasApplicationPage("app").hasDisplayName("Main menu");
    }

    @Test
    void getApplicationMenus_should_return_empty_list_when_no_elements_were_added() {
        //given
        ApplicationMenuNode menuNode = new ApplicationMenuNode();
    ...
    @Test
    void addApplicationMenu_should_add_a_new_entry_in_the_current_application_menus() {
        //given
    ...
    @Test
    void equals_should_return_true_on_different_menus_with_same_content() {
    ...
    @Test
    void equals_should_return_false_on_different_menus_with_different_content() {
        ApplicationMenuNode menu1 = ApplicationNodeBuilder.newMenu("Menu", "Page")
                .havingMenu(
                        ApplicationNodeBuilder.newMenu("Menu2", "Page2"),
                        ApplicationNodeBuilder.newMenu("Menu3", "Page3"))
