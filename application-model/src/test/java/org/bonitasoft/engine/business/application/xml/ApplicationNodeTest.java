...
class ApplicationNodeTest {
    ...
    @Test
    void getApplicationPages_should_return_empty_list_when_no_elements_were_added() {
        //given
    ...
    @Test
    void addApplicationPage_should_add_a_new_element_in_the_current_page_list() {
        //given
        final ApplicationNode applicationNode = new ApplicationNode();
    ...
    @Test
    void addApplicationMenu_should_add_a_new_element_in_the_current_menu_list() {
        //given
        final ApplicationNode applicationNode = new ApplicationNode();
