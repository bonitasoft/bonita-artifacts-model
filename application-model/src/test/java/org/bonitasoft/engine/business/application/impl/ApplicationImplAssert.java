 ...
 */
public class ApplicationImplAssert extends AbstractObjectAssert<ApplicationImplAssert, ApplicationImpl> {
    ...
    /**
     * Verifies that the actual ApplicationImpl is editable.
     * 
     * @return this assertion object.
     * @throws AssertionError - if the actual ApplicationImpl is not editable.
     */
    public ApplicationImplAssert isEditable() {
        // check that actual ApplicationImpl we want to make assertions on is not null.
        isNotNull();

        // check that property call/field access is true
        if (!actual.isEditable()) {
            failWithMessage("\nExpecting that actual ApplicationImpl is editable but is not.");
        }
    ...
    /**
     * Verifies that the actual ApplicationImpl is not editable.
     * 
     * @return this assertion object.
     * @throws AssertionError - if the actual ApplicationImpl is editable.
     */
    public ApplicationImplAssert isNotEditable() {
        // check that actual ApplicationImpl we want to make assertions on is not null.
        isNotNull();

        // check that property call/field access is false
        if (actual.isEditable()) {
            failWithMessage("\nExpecting that actual ApplicationImpl is not editable but is.");
        }
    ...
    /**
     * Verifies that the actual ApplicationImpl has icon.
     * 
     * @return this assertion object.
     * @throws AssertionError - if the actual ApplicationImpl does not have icon.
     */
    public ApplicationImplAssert hasIcon() {
        // check that actual ApplicationImpl we want to make assertions on is not null.
        isNotNull();

        // check that property call/field access is true
        if (!actual.hasIcon()) {
            failWithMessage("\nExpecting that actual ApplicationImpl has icon but does not have.");
        }
    ...
    /**
     * Verifies that the actual ApplicationImpl does not have icon.
     * 
     * @return this assertion object.
     * @throws AssertionError - if the actual ApplicationImpl has icon.
     */
    public ApplicationImplAssert doesNotHaveIcon() {
        // check that actual ApplicationImpl we want to make assertions on is not null.
        isNotNull();

        // check that property call/field access is false
        if (actual.hasIcon()) {
            failWithMessage("\nExpecting that actual ApplicationImpl does not have icon but has.");
        }
    ...
    /**
     * Verifies that the actual ApplicationImpl's visibility is equal to the given one.
     * 
     * @param visibility the given visibility to compare the actual ApplicationImpl's visibility to.
     * @return this assertion object.
     * @throws AssertionError - if the actual ApplicationImpl's visibility is not equal to the given one.
     */
    public ApplicationImplAssert hasVisibility(
