...
class SConnectorImplementationDescriptorTest {

    @Test
    void theConstructorShouldNotGenerateANullFieldForJarsDependencies() {
    ...
    @Test
    void theDefaultConstructorShouldNotGenerateANullFieldForJarsDependencies() {
        SConnectorImplementationDescriptor theConnector = new SConnectorImplementationDescriptor();
        assertThat(theConnector.getJarDependencies()).isNotNull();
    }
