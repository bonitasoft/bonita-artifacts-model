...
class UserTaskDefinitionBuilderTest {
    ...
    @Test
    void should_addExpectedDuration_as_long_create_expression() throws Exception {
        //given
    ...
    @Test
    void should_addExpectedDuration_create_expression_with_new_id() throws Exception {
        //given
        UserTaskDefinitionBuilder userTaskDefinitionBuilder = new UserTaskDefinitionBuilder(processDefinitionBuilder,
                container, "task", "actor");
    ...
    void checkExpressionIsCreated(UserTaskDefinition userTaskDefinition) {
