...
class ExpressionFinderTest {
    ...
    @Test
    void findShouldRecurseTreeForSeekedExpression() throws Exception {
    ...
    @Test
    void findShouldFindElementIfExists() throws Exception {
        DesignProcessDefinitionImpl def = new DesignProcessDefinitionImpl("name", "version");
        final ContextEntryImpl contextEntry = new ContextEntryImpl();
        contextEntry.setExpression(new ExpressionImpl());
    ...
    @Test
    void findShouldStopSearchingWhenFound() throws Exception {
        DesignProcessDefinitionImpl def = new DesignProcessDefinitionImpl("name", "version");
        final ContextEntryImpl contextEntry = new ContextEntryImpl();
