...
class ExpressionImplTest {
    ...
    @Test
    void copy_should_generate_different_ids() throws Exception {
        // when:
    ...
    @Test
    void copy_should_copy_field_values() throws Exception {
        // when:
        final Expression copy = expression.copy();
    ...
    @Test
    void constructor_should_not_set_id() throws Exception {
        // then:
